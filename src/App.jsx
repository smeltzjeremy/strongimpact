...
// Mock Gallery Component for a fallback/preview
...
export default function App() {
  return (
    <Router>
      <div className="min-h-screen bg-black text-white font-sans antialiased selection:bg-emerald-500/30 selection:text-emerald-400">
        ...
        {/* Global Route Switching Matrix */}
        <main className="pt-20">
          <Routes>
            {/* Main Showcase / Hero View */}
            <Route path="/" element={
              <div className="max-w-6xl mx-auto px-6 py-12 space-y-24">
                ...
                {/* Sub-Layout Section Separator */}
                <hr className="border-zinc-800" />

                {/* Gallery Wrapper Target */}
            ...
            {/* Catch-all Wildcard Route to safely prevent missing page breaks */}
            <Route path="*" element={<Navigate to="/" replace />} />
          </Routes>
        </main>

        {/* Global Project Blueprint Footer */}
        <footer className="border-t border-zinc-900 bg-black/40 py-8 px-6 mt-32">
