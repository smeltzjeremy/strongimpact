...
function FloatingGlassCard({
  ...
  return (
    <a
      ...
      style={cardStyle}
    >
      <div className="relative overflow-hidden rounded-3xl border border-white/[0.1] bg-white/[0.05] p-4 backdrop-blur-[28px] backdrop-saturate-[145%] transition-[border-color,box-shadow] duration-700 group-hover:border-red-900/40 group-hover:shadow-[0_0_40px_-8px_rgba(127,29,29,0.4)] sm:p-[18px]">
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(180deg, rgba(210,215,220,0.18) 0%, transparent 60%)',
          }}
        />
    ...
    <div className="relative min-h-screen overflow-x-hidden overflow-y-auto bg-[#0a0406] font-sans text-white selection:bg-red-900/40">
      ...
      <div className="relative z-10 flex min-h-screen flex-col justify-between p-4 sm:p-6">
        ...
        <header className="mx-auto mt-2 flex w-full max-w-xl items-center justify-between">
          <span
            className="rounded-full border border-white/[0.09] bg-zinc-950/50 px-3.5 py-1.5 text-[9px] font-black uppercase tracking-[0.25em] text-zinc-400 backdrop-blur-md"
            style={{
              boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.09), 0 4px 20px rgba(0,0,0,0.5)',
            }}
          >
        ...
        <main className="relative z-10 mx-auto my-auto w-full max-w-xl px-2 py-12 sm:px-10 sm:py-20 md:max-w-2xl md:px-14 md:py-24">
          <div className="relative min-h-[520px] sm:min-h-[480px] md:min-h-[440px]">
            ...
            <div
              ...
              className="relative z-20 mx-auto w-full max-w-lg overflow-hidden rounded-[40px] border border-white/[0.08] bg-zinc-950/30 p-6 backdrop-blur-2xl backdrop-saturate-[155%] sm:p-7"
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    'radial-gradient(280px circle at var(--mx) var(--my), rgba(180,185,195,0.08), transparent 62%)',
                }}
              />
              <div
              ...
              <div
                ...
                style={{
                  background:
                    'linear-gradient(90deg, transparent, rgba(127,29,29,0.26) 50%, transparent)',
                }}
              />
              ...
              <div className="relative z-10">
                ...
                <div
                  className="flex w-full items-center justify-between rounded-2xl border border-white/[0.07] bg-white/[0.03] p-3 text-[9px] font-black uppercase tracking-widest text-zinc-500"
                  style={{
                ...
                <div className="mt-4">
                  ...
                  >
                    <span
                      ...
                      style={{
                        background:
                          'linear-gradient(90deg, transparent, rgba(127,29,29,0.13) 50%, transparent)',
                      }}
                    />
            ...
            <FloatingGlassCard
              ...
              label={
                <>
                  ...
                  <span className="shrink-0 rounded border border-white/[0.07] bg-black/55 px-1.5 py-0.5 font-mono text-[8px] text-zinc-600">
                    TIERS
                  </span>
                </>
              }
